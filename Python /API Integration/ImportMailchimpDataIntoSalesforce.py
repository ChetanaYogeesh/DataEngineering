...
Error Handling:
Improved error handling within each function, especially for network requests and data parsing.
...
class SalesforceRpts:
    ...
    def api_auth(self):
        return SalesforceBulk(sessionId=self.sid, host=urllib.parse.urlparse('https://companyname.my.salesforce.com').hostname, API_version="40.0")
...
def get_salesforce_data(object_name, query):
    ...
    keys = (
        ...
        "LastName",
        "Content__c",
        "MarketingRecycleLeadsStatus__c"
    )
